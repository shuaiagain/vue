    ...
    <div class="index-wrap">
        <div class="index-left">
            ...
            <div class="index-left-block lastest-news">
                <h2>最新消息</h2>
                <ul>
                    <li v-for="itemNew in newsList">
                        <a v-bind:href="itemNew.url">{{itemNew.title}}</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="index-right">
            ...
            <slide-show v-bind:slides="slides" v-bind:time="3000"></slide-show>
...
export default {
    ...
    mounted () {
        axios.get('/mock/getNewsList?id=1').then(d => {

        }).catch(err => {

        });

        axios.post('api/getList', { id: 1 }).then(d => {
